...
class Search {
  ...
  async getResults() {
    try {
      ...
      const response = await fetch(`${base}/wp-json/genericOutdoor/v1/search?term=${query}`);
      if (!response.ok) {
      ...
      <div class="row">
        <div class="one-third">
          ...
          ${results.generalInfo.map(item => `
                <li>
                  ...
                  ${item.postType === "post" && item.authorName ? ` by ${item.authorName}` : ""}
                </li>
              `).join("")}
        ...
        <div class="one-third">
          ...
          ${results.products.length ? `<ul class="link-list min-list">` : `<p>No products match that search.</p>`}
        ...
        <div class="one-third">
          ...
          ${results.services.length ? `<ul class="link-list min-list">` : `<p>No services match that search.</p>`}
...
/*!**********************!*\
  ...
  \**********************/
__webpack_require__.r(__webpack_exports__);
/* harmony import */ var _css_scss_main_scss__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ../css/scss/main.scss */ "./css/scss/main.scss");
