...
class Search {
  ...
  keyPressDispatcher(e) {
    ...
    if (e.key === "Tab" && this.isOverlayOpen) {
      const focusableElements = [this.searchField, this.closeButton];
    ...
    document.body.insertAdjacentHTML(
      ...
      <div class="search-overlay" role="dialog" aria-modal="true" aria-hidden="true" aria-labelledby="search-overlay-title">
        <div class="search-overlay__top">
          <div class="container">
            <h2 id="search-overlay-title" class="u-sr-only">Site search</h2>
            <svg
            ...
            <label class="u-sr-only" for="search-term">Search this site</label>
            <input
              type="text"
              class="search-term"
